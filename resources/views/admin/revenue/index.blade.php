...
<form action="/revenue/searchRange/" method="POST" >
...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <div class="card-header">
        <h3 class="card-title">Biểu đồ tăng trưởng doanh thu</h3>
        <div class="card-tools">
        <button type="button" class="btn btn-tool" data-card-widget="collapse">
        <i class="fas fa-minus"></i>
        </button>
        ...
        <div class="card-body">
        <div class="chart"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
        <canvas id="lineChart" style="min-height: 250px; height: 250px; max-height: 250px; max-width: 100%; display: block; width: 304px;" width="608" height="500" class="chartjs-render-monitor"></canvas>
        </div>
        </div>
