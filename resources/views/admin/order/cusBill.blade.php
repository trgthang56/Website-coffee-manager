...
<div class="row">
    ...
    <h3 class="card-title">Các đơn hàng khách order</h3>
   ...
   <div class="card-body table-responsive p-0">
    ...
    <td ><a class="btn btn-app"  href="/customer/detail/show/{{ $item->id }}" data-id="{{$item->id}}" onclick="checked(this)">
...
cell2.innerHTML = e.o.table.name;
if(e.o.mess === '') { cell3.innerHTML = "Không có ghi chú";}else {cell3.innerHTML = e.o.mess;}
cell4.innerHTML = e.o.status;
cell5.innerHTML = date;
cell6.innerHTML = date;
var html = '<a class=\"btn btn-app\"  href=\"/customer/detail/show/'+e.o.id+'\" data-id=\"'+e.o.id+'\" onclick=\"checked(this)\">'+'<i class=\"fas fa-edit\"></i> Chi tiết'+'<span class=\"badge bg-danger\" id=\"new_'+e.o.id+'\">Mới</span>'
      +'</a>';
